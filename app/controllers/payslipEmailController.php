...
class payslipEmailController extends \BaseController {
    ...
    public function sendEmail()
    {
        ...
        $pdf = PDF::loadView('pdf.monthlySlip', compact('employee','rels','overtimes','nontaxables','transact','allws','deds','earnings','period','currencies', 'organization'))->setPaper('a4')->setOrientation('potrait');
     ...
     return Redirect::back()->with('success', 'Email Sent!');
        ...
        $filePath = 'app/views/temp/';
        $pdf = PDF::loadView('pdf.monthlySlip', compact('employee','overtimes','nontaxables','rels','transact','allws','deds','earnings','period','currencies', 'organization'))->setPaper('a4')->setOrientation('potrait');
